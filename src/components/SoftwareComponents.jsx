...
const Facilities = [
  { id:1,
    heading: "English Speaking Programmers",
  },
  { id:2,
    heading: "Flexible Work Hours",
  },
  { id:3,
    heading: "Rapid Onboarding Process",
  },
  { id:4,
    heading: "Expertise In Top Technologies",
  },
  { id:5,
    heading: "Reliable Partner Credentials",
  },
];
    ...
    <section className=" py-20 bg-[#0a0c3d] text-white ">
      <div className="max-w-7xl  mx-auto py-16 px-4  text-white relative grid lg:grid-cols-2 gap-12 items-center">
        ...
        <div className=" relative h-full max-w-3xl text-white overflow-hidden">
          <img src={PeopleImg} className="w-full h-full object-cover min-h-125 " alt="" />
        ...
        {/* Right Side  */}
        <div className="relative right-0 w-full max-w-2xl">
